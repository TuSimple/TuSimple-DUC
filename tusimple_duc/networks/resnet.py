...
def get_resnet_hdc(bn_use_global_stats=True):
    ...
    res4b2 = ResidualFactory_x(res4b1, 256, 256, 1024, (2, 2), '4_3')
    res4b3 = ResidualFactory_x(res4b2, 256, 256, 1024, (2, 2), '4_4')
    res4b4 = ResidualFactory_x(res4b3, 256, 256, 1024, (2, 2), '4_5')
    res4b5 = ResidualFactory_x(res4b4, 256, 256, 1024, (2, 2), '4_6')
    res4b6 = ResidualFactory_x(res4b5, 256, 256, 1024, (2, 2), '4_7')
    res4b7 = ResidualFactory_x(res4b6, 256, 256, 1024, (2, 2), '4_8')
    res4b8 = ResidualFactory_x(res4b7, 256, 256, 1024, (2, 2), '4_9')
    res4b9 = ResidualFactory_x(res4b8, 256, 256, 1024, (2, 2), '4_10')
    res4b10 = ResidualFactory_x(res4b9, 256, 256, 1024, (2, 2), '4_11')
    res4b11 = ResidualFactory_x(res4b10, 256, 256, 1024, (2, 2), '4_12')
    res4b12 = ResidualFactory_x(res4b11, 256, 256, 1024, (2, 2), '4_13')
    res4b13 = ResidualFactory_x(res4b12, 256, 256, 1024, (2, 2), '4_14')
    res4b14 = ResidualFactory_x(res4b13, 256, 256, 1024, (2, 2), '4_15')
    res4b15 = ResidualFactory_x(res4b14, 256, 256, 1024, (2, 2), '4_16')
    res4b16 = ResidualFactory_x(res4b15, 256, 256, 1024, (2, 2), '4_17')
    res4b17 = ResidualFactory_x(res4b16, 256, 256, 1024, (2, 2), '4_18')
    res4b18 = ResidualFactory_x(res4b17, 256, 256, 1024, (2, 2), '4_19')
    res4b19 = ResidualFactory_x(res4b18, 256, 256, 1024, (2, 2), '4_20')
    res4b20 = ResidualFactory_x(res4b19, 256, 256, 1024, (2, 2), '4_21')
    res4b21 = ResidualFactory_x(res4b20, 256, 256, 1024, (2, 2), '4_22')
    res4b22 = ResidualFactory_x(res4b21, 256, 256, 1024, (2, 2), '4_23')

    # group 5
    res5a = ResidualFactory_o(res4b22, 512, 512, 2048, (4, 4), '5_1')
    res5b = ResidualFactory_x(res5a, 512, 512, 2048, (4, 4), '5_2')
    res5c = ResidualFactory_x(res5b, 512, 512, 2048, (4, 4), '5_3')
    return res5c
